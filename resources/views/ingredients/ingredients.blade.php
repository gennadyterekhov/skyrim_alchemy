...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100  sm:items-center py-4 sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        @foreach ($ingredients as $ingredient)
            <div><b>Ingredient {{ $ingredient['id'] }}:</b></div>
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
...
{{--                $ingredient['effect_1']--}}
                ...
                <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    Effect 1
                    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                        <span>id: {{ $ingredient['effect_1']['id'] }}</span><br>
                ...
                <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    Effect 2
                    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                        <span>id: {{ $ingredient['effect_2']['id'] }}</span><br>
                ...
                <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    Effect 3
                    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                        <span>id: {{ $ingredient['effect_3']['id'] }}</span><br>
                ...
                <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    Effect 4
                    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                        <span>id: {{ $ingredient['effect_4']['id'] }}</span><br>
